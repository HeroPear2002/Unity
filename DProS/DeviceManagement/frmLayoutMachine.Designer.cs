...
namespace DProS.DeviceManagement
{
	partial class frmLayoutMachine
	{
		...
		private void InitializeComponent()
		{
			...
			this.layoutControl1.Controls.Add(this.btnHistoryEdit);
			this.layoutControl1.Controls.Add(this.label15);
			this.layoutControl1.Controls.Add(this.btnInforMachine);
			this.layoutControl1.Controls.Add(this.btnCheckMainten);
			this.layoutControl1.Controls.Add(this.btnCheckEveryday);
			...
			// btnHistoryEdit
			// 
			this.btnHistoryEdit.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnHistoryEdit.ImageOptions.Image")));
			this.btnHistoryEdit.Location = new System.Drawing.Point(402, 12);
			this.btnHistoryEdit.Name = "btnHistoryEdit";
			this.btnHistoryEdit.Size = new System.Drawing.Size(113, 22);
			this.btnHistoryEdit.StyleController = this.layoutControl1;
			...
			// btnInforMachine
			// 
			this.btnInforMachine.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnInforMachine.ImageOptions.Image")));
			this.btnInforMachine.Location = new System.Drawing.Point(283, 12);
			this.btnInforMachine.Name = "btnInforMachine";
			this.btnInforMachine.Size = new System.Drawing.Size(104, 22);
			this.btnInforMachine.StyleController = this.layoutControl1;
			this.btnInforMachine.TabIndex = 7;
			this.btnInforMachine.Text = "Thông tin máy";
			this.btnInforMachine.Click += new System.EventHandler(this.btnInforMachine_Click);
			// 
			// btnCheckMainten
			// 
			this.btnCheckMainten.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnCheckMainten.ImageOptions.Image")));
			this.btnCheckMainten.Location = new System.Drawing.Point(156, 12);
			this.btnCheckMainten.Name = "btnCheckMainten";
			this.btnCheckMainten.Size = new System.Drawing.Size(113, 22);
			this.btnCheckMainten.StyleController = this.layoutControl1;
			this.btnCheckMainten.TabIndex = 6;
			this.btnCheckMainten.Text = "Kiểm tra định kỳ";
			this.btnCheckMainten.Click += new System.EventHandler(this.btnCheckMainten_Click);
			// 
			// btnCheckEveryday
			// 
			this.btnCheckEveryday.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnCheckEveryday.ImageOptions.Image")));
			this.btnCheckEveryday.Location = new System.Drawing.Point(12, 12);
			this.btnCheckEveryday.Name = "btnCheckEveryday";
			this.btnCheckEveryday.Size = new System.Drawing.Size(130, 22);
			this.btnCheckEveryday.StyleController = this.layoutControl1;
			this.btnCheckEveryday.TabIndex = 5;
			this.btnCheckEveryday.Text = "Kiểm tra hàng ngày";
			this.btnCheckEveryday.Click += new System.EventHandler(this.btnCheckEveryday_Click);
			// 
			// btnUpdate
			// 
			this.btnUpdate.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnUpdate.ImageOptions.Image")));
			this.btnUpdate.Location = new System.Drawing.Point(529, 12);
			...
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.btnUpdate;
			...
			// layoutControlItem2
			// 
			this.layoutControlItem2.Control = this.btnCheckEveryday;
			...
			// layoutControlItem3
			// 
			this.layoutControlItem3.Control = this.btnCheckMainten;
			...
			// layoutControlItem4
			// 
			this.layoutControlItem4.Control = this.btnInforMachine;
			...
			// layoutControlItem5
			// 
			this.layoutControlItem5.Control = this.btnHistoryEdit;
			...
			this.emptySpaceItem5.Location = new System.Drawing.Point(379, 0);
			...
			this.emptySpaceItem6.Location = new System.Drawing.Point(507, 0);
			...
			this.emptySpaceItem7.Location = new System.Drawing.Point(596, 0);
			this.emptySpaceItem7.Name = "emptySpaceItem7";
			this.emptySpaceItem7.Size = new System.Drawing.Size(536, 26);
		...
		private DevExpress.XtraEditors.SimpleButton btnHistoryEdit;
		private DevExpress.XtraEditors.SimpleButton btnInforMachine;
		private DevExpress.XtraEditors.SimpleButton btnCheckMainten;
		private DevExpress.XtraEditors.SimpleButton btnCheckEveryday;
