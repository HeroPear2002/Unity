namespace DProS.DeviceManagement
{
	partial class frmMachineList
	{
		...
		private void InitializeComponent()
		{
			...
			this.gcMachineList = new DevExpress.XtraGrid.GridControl();
			this.gvMachineList = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.gvcSerialNumber = new DevExpress.XtraGrid.Columns.GridColumn();
			this.gvcManufacturer = new DevExpress.XtraGrid.Columns.GridColumn();
			this.gvcVender = new DevExpress.XtraGrid.Columns.GridColumn();
			this.gvcDateMaker = new DevExpress.XtraGrid.Columns.GridColumn();
			this.gvcDateInput = new DevExpress.XtraGrid.Columns.GridColumn();
			this.gvcDateProduct = new DevExpress.XtraGrid.Columns.GridColumn();
			this.gvcDateUse = new DevExpress.XtraGrid.Columns.GridColumn();
			this.gvcCodeAsset = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.btnSampleForm = new DevExpress.XtraEditors.SimpleButton();
			this.btnInsert = new DevExpress.XtraEditors.SimpleButton();
			this.btnSave = new DevExpress.XtraEditors.SimpleButton();
			this.btnEdit = new DevExpress.XtraEditors.SimpleButton();
			this.btnDelete = new DevExpress.XtraEditors.SimpleButton();
			this.btnMachineTemporary = new DevExpress.XtraEditors.SimpleButton();
			this.btnUpdate = new DevExpress.XtraEditors.SimpleButton();
			this.dtpDateMaker = new System.Windows.Forms.DateTimePicker();
			...
			this.lab4 = new DevExpress.XtraLayout.LayoutControlItem();
			...
			((System.ComponentModel.ISupportInitialize)(this.gcMachineList)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gvMachineList)).BeginInit();
			...
			// layoutControl1
			// 
			this.layoutControl1.Controls.Add(this.gcMachineList);
			this.layoutControl1.Controls.Add(this.btnExportExcel);
			this.layoutControl1.Controls.Add(this.btnImportExcel);
			this.layoutControl1.Controls.Add(this.btnSampleForm);
			this.layoutControl1.Controls.Add(this.btnInsert);
			this.layoutControl1.Controls.Add(this.btnSave);
			this.layoutControl1.Controls.Add(this.btnEdit);
			this.layoutControl1.Controls.Add(this.btnDelete);
			this.layoutControl1.Controls.Add(this.btnMachineTemporary);
			this.layoutControl1.Controls.Add(this.btnUpdate);
			this.layoutControl1.Controls.Add(this.dtpDateMaker);
			this.layoutControl1.Controls.Add(this.dtpDateInput);
			this.layoutControl1.Controls.Add(this.dtpDateProduct);
			...
			this.layoutControl1.Controls.Add(this.txtCodeAsset);
			...
			// gvMachineList
			// 
			this.gvMachineList.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
            this.gvcMachineCode,
            this.gvcMachineName,
            this.gvcSerialNumber,
            this.gvcManufacturer,
            this.gvcVender,
            this.gvcDateMaker,
            this.gvcDateInput,
            this.gvcDateProduct,
            ...
            this.gvcCodeAsset,
            this.gvcId});
			this.gvMachineList.DetailHeight = 404;
			this.gvMachineList.GridControl = this.gcMachineList;
			this.gvMachineList.Name = "gvMachineList";
			this.gvMachineList.OptionsCustomization.AllowGroup = false;
			this.gvMachineList.OptionsSelection.MultiSelect = true;
			...
			this.gvcMachineName.Width = 193;
			// 
			// gvcSerialNumber
			// 
			this.gvcSerialNumber.AppearanceCell.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcSerialNumber.AppearanceCell.Options.UseFont = true;
			this.gvcSerialNumber.AppearanceHeader.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcSerialNumber.AppearanceHeader.Options.UseFont = true;
			this.gvcSerialNumber.AppearanceHeader.Options.UseTextOptions = true;
			this.gvcSerialNumber.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gvcSerialNumber.Caption = "Số serial";
			this.gvcSerialNumber.FieldName = "SerialNumber";
			this.gvcSerialNumber.Name = "gvcSerialNumber";
			this.gvcSerialNumber.Visible = true;
			this.gvcSerialNumber.VisibleIndex = 3;
			this.gvcSerialNumber.Width = 193;
			// 
			// gvcManufacturer
			// 
			this.gvcManufacturer.AppearanceCell.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcManufacturer.AppearanceCell.Options.UseFont = true;
			this.gvcManufacturer.AppearanceHeader.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcManufacturer.AppearanceHeader.Options.UseFont = true;
			this.gvcManufacturer.AppearanceHeader.Options.UseTextOptions = true;
			this.gvcManufacturer.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gvcManufacturer.Caption = "Nhà sản xuất";
			this.gvcManufacturer.FieldName = "Manufacturer";
			this.gvcManufacturer.Name = "gvcManufacturer";
			this.gvcManufacturer.Visible = true;
			this.gvcManufacturer.VisibleIndex = 4;
			this.gvcManufacturer.Width = 105;
			// 
			// gvcVender
			// 
			this.gvcVender.AppearanceCell.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcVender.AppearanceCell.Options.UseFont = true;
			this.gvcVender.AppearanceHeader.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcVender.AppearanceHeader.Options.UseFont = true;
			this.gvcVender.AppearanceHeader.Options.UseTextOptions = true;
			this.gvcVender.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gvcVender.Caption = "Nhà cung cấp";
			this.gvcVender.FieldName = "Vender";
			this.gvcVender.Name = "gvcVender";
			this.gvcVender.Visible = true;
			this.gvcVender.VisibleIndex = 5;
			this.gvcVender.Width = 104;
			// 
			// gvcDateMaker
			// 
			this.gvcDateMaker.AppearanceCell.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcDateMaker.AppearanceCell.Options.UseFont = true;
			this.gvcDateMaker.AppearanceHeader.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcDateMaker.AppearanceHeader.Options.UseFont = true;
			this.gvcDateMaker.AppearanceHeader.Options.UseTextOptions = true;
			this.gvcDateMaker.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gvcDateMaker.Caption = "Ngày chế tạo TB";
			this.gvcDateMaker.FieldName = "DateMaker";
			this.gvcDateMaker.Name = "gvcDateMaker";
			this.gvcDateMaker.Visible = true;
			this.gvcDateMaker.VisibleIndex = 6;
			this.gvcDateMaker.Width = 105;
			// 
			// gvcDateInput
			// 
			this.gvcDateInput.AppearanceCell.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcDateInput.AppearanceCell.Options.UseFont = true;
			this.gvcDateInput.AppearanceHeader.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcDateInput.AppearanceHeader.Options.UseFont = true;
			this.gvcDateInput.AppearanceHeader.Options.UseTextOptions = true;
			this.gvcDateInput.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gvcDateInput.Caption = "Ngày nhập";
			this.gvcDateInput.FieldName = "DateInput";
			this.gvcDateInput.Name = "gvcDateInput";
			this.gvcDateInput.Visible = true;
			this.gvcDateInput.VisibleIndex = 7;
			this.gvcDateInput.Width = 101;
			// 
			// gvcDateProduct
			// 
			this.gvcDateProduct.AppearanceCell.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcDateProduct.AppearanceCell.Options.UseFont = true;
			this.gvcDateProduct.AppearanceHeader.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcDateProduct.AppearanceHeader.Options.UseFont = true;
			this.gvcDateProduct.AppearanceHeader.Options.UseTextOptions = true;
			this.gvcDateProduct.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gvcDateProduct.Caption = "Ngày bắt đầu SD";
			this.gvcDateProduct.FieldName = "DateProduct";
			this.gvcDateProduct.Name = "gvcDateProduct";
			this.gvcDateProduct.Visible = true;
			this.gvcDateProduct.VisibleIndex = 8;
			this.gvcDateProduct.Width = 139;
			// 
			// gvcDateUse
			// 
			this.gvcDateUse.AppearanceCell.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcDateUse.AppearanceCell.Options.UseFont = true;
			this.gvcDateUse.AppearanceHeader.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcDateUse.AppearanceHeader.Options.UseFont = true;
			this.gvcDateUse.AppearanceHeader.Options.UseTextOptions = true;
			this.gvcDateUse.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gvcDateUse.Caption = "Thời gian SD ( Tháng )";
			this.gvcDateUse.FieldName = "DateUse";
			this.gvcDateUse.Name = "gvcDateUse";
			this.gvcDateUse.Visible = true;
			this.gvcDateUse.VisibleIndex = 9;
			this.gvcDateUse.Width = 113;
			// 
			// gvcCodeAsset
			// 
			this.gvcCodeAsset.AppearanceCell.Font = new System.Drawing.Font("Times New Roman", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcCodeAsset.AppearanceCell.Options.UseFont = true;
			this.gvcCodeAsset.AppearanceHeader.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.gvcCodeAsset.AppearanceHeader.Options.UseFont = true;
			this.gvcCodeAsset.AppearanceHeader.Options.UseTextOptions = true;
			this.gvcCodeAsset.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.gvcCodeAsset.Caption = "Mã TSCĐ";
			this.gvcCodeAsset.FieldName = "CodeAsset";
			this.gvcCodeAsset.Name = "gvcCodeAsset";
			this.gvcCodeAsset.Visible = true;
			this.gvcCodeAsset.VisibleIndex = 10;
			this.gvcCodeAsset.Width = 121;
			// 
			// gvcId
			// 
			...
			this.btnExportExcel.Location = new System.Drawing.Point(950, 126);
			this.btnExportExcel.Name = "btnExportExcel";
			this.btnExportExcel.Size = new System.Drawing.Size(91, 22);
			...
			this.btnImportExcel.Location = new System.Drawing.Point(1158, 126);
			this.btnImportExcel.Name = "btnImportExcel";
			this.btnImportExcel.Size = new System.Drawing.Size(103, 22);
			...
			// btnSampleForm
			// 
			this.btnSampleForm.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnSampleForm.ImageOptions.Image")));
			this.btnSampleForm.Location = new System.Drawing.Point(1055, 126);
			this.btnSampleForm.Name = "btnSampleForm";
			this.btnSampleForm.Size = new System.Drawing.Size(89, 22);
			this.btnSampleForm.StyleController = this.layoutControl1;
			this.btnSampleForm.TabIndex = 19;
			this.btnSampleForm.Text = "Form mẫu";
			this.btnSampleForm.Click += new System.EventHandler(this.btnSampleForm_Click);
			// 
			// btnInsert
			// 
			this.btnInsert.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnInsert.ImageOptions.Image")));
			this.btnInsert.Location = new System.Drawing.Point(12, 126);
			...
			this.btnSave.Location = new System.Drawing.Point(275, 126);
			...
			// btnMachineTemporary
			// 
			this.btnMachineTemporary.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnMachineTemporary.ImageOptions.Image")));
			this.btnMachineTemporary.Location = new System.Drawing.Point(366, 126);
			this.btnMachineTemporary.Name = "btnMachineTemporary";
			this.btnMachineTemporary.Size = new System.Drawing.Size(83, 22);
			this.btnMachineTemporary.StyleController = this.layoutControl1;
			this.btnMachineTemporary.TabIndex = 14;
			this.btnMachineTemporary.Text = "Máy tạm";
			this.btnMachineTemporary.Click += new System.EventHandler(this.btnMachineTemporary_Click);
			// 
			// btnUpdate
			// 
			this.btnUpdate.ImageOptions.Image = ((System.Drawing.Image)(resources.GetObject("btnUpdate.ImageOptions.Image")));
			this.btnUpdate.Location = new System.Drawing.Point(1277, 126);
			...
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.txtSerialNumber;
			...
			// layoutControlItem2
			// 
			this.layoutControlItem2.Control = this.txtCodeAsset;
			...
			// lab4
			// 
			this.lab4.Control = this.txtMachineName;
			...
			// layoutControlItem5
			// 
			this.layoutControlItem5.Control = this.txtVender;
			...
			this.layoutControlItem10.Location = new System.Drawing.Point(1265, 114);
			this.layoutControlItem10.Name = "layoutControlItem10";
			this.layoutControlItem10.Size = new System.Drawing.Size(79, 26);
			this.layoutControlItem10.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem10.TextVisible = false;
			// 
			// layoutControlItem11
			// 
			this.layoutControlItem11.Control = this.btnMachineTemporary;
			this.layoutControlItem11.Location = new System.Drawing.Point(354, 114);
			...
			this.layoutControlItem12.Location = new System.Drawing.Point(177, 114);
			...
			this.layoutControlItem13.Location = new System.Drawing.Point(90, 114);
			...
			this.layoutControlItem14.Location = new System.Drawing.Point(263, 114);
			...
			// layoutControlItem15
			// 
			this.layoutControlItem15.Control = this.btnInsert;
			...
			// layoutControlItem16
			// 
			this.layoutControlItem16.Control = this.btnSampleForm;
			this.layoutControlItem16.Location = new System.Drawing.Point(1043, 114);
			...
			// layoutControlItem18
			// 
			this.layoutControlItem18.Control = this.btnImportExcel;
			this.layoutControlItem18.Location = new System.Drawing.Point(1146, 114);
			...
			// layoutControlItem19
			// 
			this.layoutControlItem19.Control = this.btnExportExcel;
			this.layoutControlItem19.Location = new System.Drawing.Point(938, 114);
			...
			// layoutControlItem6
			// 
			this.layoutControlItem6.Control = this.txtMachineCode;
			...
			// layoutControlItem3
			// 
			this.layoutControlItem3.Control = this.txtManufacturer;
			...
			this.emptySpaceItem10.Location = new System.Drawing.Point(455, 20);
			...
			this.emptySpaceItem11.Location = new System.Drawing.Point(455, 44);
			this.emptySpaceItem11.Name = "emptySpaceItem11";
			this.emptySpaceItem11.Size = new System.Drawing.Size(10, 24);
			this.emptySpaceItem11.TextSize = new System.Drawing.Size(0, 0);
			// 
			// emptySpaceItem12
			// 
			this.emptySpaceItem12.AllowHotTrack = false;
			this.emptySpaceItem12.Location = new System.Drawing.Point(929, 20);
			...
			this.emptySpaceItem13.Location = new System.Drawing.Point(929, 44);
			...
			this.simpleSeparator1.Size = new System.Drawing.Size(1344, 1);
			// 
			// simpleSeparator2
			// 
			...
			this.simpleSeparator2.Size = new System.Drawing.Size(1344, 1);
			// 
			// simpleSeparator3
			// 
			this.simpleSeparator3.AllowHotTrack = false;
			this.simpleSeparator3.Location = new System.Drawing.Point(1343, 20);
			this.simpleSeparator3.Name = "simpleSeparator3";
			this.simpleSeparator3.Size = new System.Drawing.Size(1, 48);
			// 
			// simpleSeparator4
			// 
			this.simpleSeparator4.AllowHotTrack = false;
			this.simpleSeparator4.Location = new System.Drawing.Point(0, 20);
			this.simpleSeparator4.Name = "simpleSeparator4";
			this.simpleSeparator4.Size = new System.Drawing.Size(1, 48);
			// 
			// simpleLabelItem1
			// 
			...
			this.simpleLabelItem1.Size = new System.Drawing.Size(1344, 19);
			this.simpleLabelItem1.Text = "Thông tin";
			this.simpleLabelItem1.TextSize = new System.Drawing.Size(102, 15);
			// 
			// simpleSeparator5
			// 
			this.simpleSeparator5.AllowHotTrack = false;
			this.simpleSeparator5.Location = new System.Drawing.Point(0, 89);
			...
			this.simpleSeparator6.Size = new System.Drawing.Size(1344, 1);
			// 
			// simpleSeparator7
			// 
			this.simpleSeparator7.AllowHotTrack = false;
			this.simpleSeparator7.Location = new System.Drawing.Point(1343, 89);
			this.simpleSeparator7.Name = "simpleSeparator7";
			this.simpleSeparator7.Size = new System.Drawing.Size(1, 24);
			// 
			// simpleSeparator8
			// 
			this.simpleSeparator8.AllowHotTrack = false;
			this.simpleSeparator8.Location = new System.Drawing.Point(0, 113);
			this.simpleSeparator8.Name = "simpleSeparator8";
			this.simpleSeparator8.Size = new System.Drawing.Size(1344, 1);
			// 
			// simpleLabelItem2
			// 
			this.simpleLabelItem2.AllowHotTrack = false;
			this.simpleLabelItem2.Location = new System.Drawing.Point(0, 69);
			this.simpleLabelItem2.Name = "simpleLabelItem2";
			this.simpleLabelItem2.Size = new System.Drawing.Size(1344, 19);
			this.simpleLabelItem2.Text = "Ngày / tháng / năm";
			this.simpleLabelItem2.TextSize = new System.Drawing.Size(102, 15);
			// 
			// emptySpaceItem19
			// 
			this.emptySpaceItem19.AllowHotTrack = false;
			this.emptySpaceItem19.Location = new System.Drawing.Point(80, 114);
			...
			this.emptySpaceItem20.Location = new System.Drawing.Point(167, 114);
			this.emptySpaceItem20.Name = "emptySpaceItem20";
			this.emptySpaceItem20.Size = new System.Drawing.Size(10, 26);
			this.emptySpaceItem20.TextSize = new System.Drawing.Size(0, 0);
			// 
			// emptySpaceItem21
			// 
			this.emptySpaceItem21.AllowHotTrack = false;
			this.emptySpaceItem21.Location = new System.Drawing.Point(253, 114);
			this.emptySpaceItem21.Name = "emptySpaceItem21";
			this.emptySpaceItem21.Size = new System.Drawing.Size(10, 26);
			this.emptySpaceItem21.TextSize = new System.Drawing.Size(0, 0);
			// 
			// emptySpaceItem22
			// 
			this.emptySpaceItem22.AllowHotTrack = false;
			this.emptySpaceItem22.Location = new System.Drawing.Point(344, 114);
			...
			this.emptySpaceItem24.Location = new System.Drawing.Point(441, 114);
			this.emptySpaceItem24.Name = "emptySpaceItem24";
			this.emptySpaceItem24.Size = new System.Drawing.Size(497, 26);
			this.emptySpaceItem24.TextSize = new System.Drawing.Size(0, 0);
			// 
			// emptySpaceItem25
			// 
			this.emptySpaceItem25.AllowHotTrack = false;
			this.emptySpaceItem25.Location = new System.Drawing.Point(1033, 114);
			this.emptySpaceItem25.Name = "emptySpaceItem25";
			this.emptySpaceItem25.Size = new System.Drawing.Size(10, 26);
			this.emptySpaceItem25.TextSize = new System.Drawing.Size(0, 0);
			// 
			// emptySpaceItem26
			// 
			this.emptySpaceItem26.AllowHotTrack = false;
			this.emptySpaceItem26.Location = new System.Drawing.Point(1136, 114);
			this.emptySpaceItem26.Name = "emptySpaceItem26";
			this.emptySpaceItem26.Size = new System.Drawing.Size(10, 26);
			this.emptySpaceItem26.TextSize = new System.Drawing.Size(0, 0);
			// 
			// emptySpaceItem27
			// 
			this.emptySpaceItem27.AllowHotTrack = false;
			this.emptySpaceItem27.Location = new System.Drawing.Point(1253, 114);
			this.emptySpaceItem27.Name = "emptySpaceItem27";
			this.emptySpaceItem27.Size = new System.Drawing.Size(12, 26);
			...
			this.Text = "Danh Sách Máy Móc";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			((System.ComponentModel.ISupportInitialize)(this.layoutControl1)).EndInit();
			this.layoutControl1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.gcMachineList)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gvMachineList)).EndInit();
		...
		private DevExpress.XtraEditors.SimpleButton btnSampleForm;
		private DevExpress.XtraEditors.SimpleButton btnInsert;
		private DevExpress.XtraEditors.SimpleButton btnSave;
		private DevExpress.XtraEditors.SimpleButton btnEdit;
		private DevExpress.XtraEditors.SimpleButton btnDelete;
		private DevExpress.XtraEditors.SimpleButton btnMachineTemporary;
		private DevExpress.XtraEditors.SimpleButton btnUpdate;
		private System.Windows.Forms.DateTimePicker dtpDateMaker;
		...
		private DevExpress.XtraLayout.LayoutControlItem lab4;
		...
		private DevExpress.XtraGrid.GridControl gcMachineList;
		private DevExpress.XtraGrid.Views.Grid.GridView gvMachineList;
		...
		private DevExpress.XtraGrid.Columns.GridColumn gvcSerialNumber;
		private DevExpress.XtraGrid.Columns.GridColumn gvcManufacturer;
		private DevExpress.XtraGrid.Columns.GridColumn gvcVender;
		private DevExpress.XtraGrid.Columns.GridColumn gvcDateMaker;
		private DevExpress.XtraGrid.Columns.GridColumn gvcDateInput;
		private DevExpress.XtraGrid.Columns.GridColumn gvcDateProduct;
		private DevExpress.XtraGrid.Columns.GridColumn gvcDateUse;
		private DevExpress.XtraGrid.Columns.GridColumn gvcCodeAsset;
